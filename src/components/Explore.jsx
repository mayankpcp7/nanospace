...
import robotFace from "../assets/images/webp/explore-face-vector.webp";
import { EXPLORE_ITEMS } from "../utils/helper";
import Heading from "./common/Heading";
const Explore = () => {
  return (
    <div className="bg-custom-black -mt-[1px] relative z-50 overflow-hidden">
      <div className="container z-20 sm:py-16 py-12 md:py-20 lg:py-24 xl:py-44 max-w-[1172px] px-4 mx-auto relative">
        <img
          className="absolute w-full bottom-[-15%] xl:top-[-174px] z-50 start-[-83px] xl:start-[-211px] lg:block hidden max-w-[600px] lg:max-w-[650px] xl:max-w-[1035px]"
          src={girl}
          alt="girl"
        />
